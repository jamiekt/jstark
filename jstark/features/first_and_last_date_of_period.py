...
class FirstAndLastDateOfPeriod:
    ...
    def first_date_in_week(self) -> date:
        current_weekday_index = self._weekdays.index(
            self._date_in_period.strftime("%A")
        )
        first_day_index = self._weekdays.index(self._first_day_of_week)
        ...
        return self._date_in_period - timedelta(days=days_to_subtract)
    ...
    def first_date_in_month(self) -> date:
        return date(self._date_in_period.year, self._date_in_period.month, 1)
    ...
    def first_date_in_quarter(self) -> date:
        match self._date_in_period.month:
            case 1 | 2 | 3:
                return date(self._date_in_period.year, 1, 1)
            case 4 | 5 | 6:
                return date(self._date_in_period.year, 4, 1)
            case 7 | 8 | 9:
                return date(self._date_in_period.year, 7, 1)
            case _:  # all other months:
                return date(self._date_in_period.year, 10, 1)

    @property
    def last_date_in_quarter(self) -> date:
        match self._date_in_period.month:
            case 1 | 2 | 3:
                return date(self._date_in_period.year, 3, 31)
            case 4 | 5 | 6:
                return date(self._date_in_period.year, 6, 30)
            case 7 | 8 | 9:
                return date(self._date_in_period.year, 9, 30)
            case _:  # all other months:
                return date(self._date_in_period.year, 12, 31)
